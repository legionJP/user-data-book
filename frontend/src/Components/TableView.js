...
function TableView() {
  ...
  return (
    <div>
    <div style={{justifyContent:"space-between"}} className="filter">
      <div className="search-bar" style={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px", backgroundColor:"lightblue" }}>
        <SearchIcon style={{ marginLeft: "10px" }} />
        {
          categorySearch === "dob" ?
            ...
            ></input>
            :
            <input type="text" style={{backgroundColor:"lightblue"}} name="searchText" value={textSearch} placeholder="Search"
      ...
      <FormControl style={{ width: "30%" }}>
        ...
        >
          ...
          <MenuItem value="phoneNumber">Mobile number</MenuItem>
      ...
      <div className="tableview-table">
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            ...
            <TableHead className="tbody-head">
              <TableRow>
